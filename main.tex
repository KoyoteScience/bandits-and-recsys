...
\documentclass[manuscript, nonacm, screen=true]{acmart}
\geometry{twoside=false,bottom=100pt}
...
%% Numbered references, preferred, without acmart
...
%% Uncommenting the next command will enable author year style.
...
%   \postcode{94114}
% }
\renewcommand{\shortauthors}{The Koyote Science, LLC, Approach to Personalization and Recommender Systems} % and Cote
...
% \fancyhf{}
\cfoot{\\ \hfill \break
\includegraphics[scale=0.15,align=c]{koyote_science_logo.png}
}
